  ...
  if (activeGame && activeGame.phase?.stage !== 'Lobby') {
    return (
      <ActiveGameScreen
        ...
        endOfRoundModal={persistedEndOfRoundSummary && !isEndOfRoundModalDismissed ? (
  ...
  if (activeLobbySession?.gameId && activeLobbySession?.game) {
    return (
      <LobbyScreen
        ...
        shareIcon={ShareIcon}
        shareModal={isLobbyShareModalOpen ? (
          <div
            className="fixed inset-0 z-[60] flex items-center justify-center overflow-y-auto bg-black/70 px-4 py-4"
        ...
        removePlayerModal={pendingLobbyRemovePlayer ? (
          <div
            className="fixed inset-0 z-[60] flex items-center justify-center overflow-y-auto bg-black/70 px-4 py-4"
        ...
        removeSeatModal={pendingLobbyRemoveSeat ? (
          <div
            className="fixed inset-0 z-[60] flex items-center justify-center overflow-y-auto bg-black/70 px-4 py-4"
        ...
        renamePlayerModal={pendingLobbyRenamePlayer ? (
          <div
            className="fixed inset-0 z-[60] flex items-center justify-center overflow-y-auto bg-black/70 px-4 py-4"
