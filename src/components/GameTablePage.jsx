  ...
  return (
    <div className="contents">
      ...
      <section className="relative mx-auto flex h-[calc(100dvh-var(--mobile-action-bar-height,0px))] w-full max-w-none flex-col md:h-full md:max-w-6xl">
        ...
        <GameTableHeader onGoHome={onGoHome} trumpCard={trumpCard} />
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[30%_1fr]">
          ...
          {game.phase?.stage === 'Bidding' ? (
            ...
            <GameTableTrickArea
              ...
              displayedTrickPlays={displayedTrickPlays}
              game={game}
              getPassiveTrickPlayerLabel={getPassiveTrickPlayerLabel}
              handleSelectTrickCard={handleSelectTrickCard}
              isGameOver={isGameOver}
              leadTrickPlayerId={leadTrickPlayerId}
              passiveTrickLabelStyles={passiveTrickLabelStyles}
              returningTrickLabel={returningTrickLabel}
              scatterTrickPositionsByPlayerId={scatterTrickPositionsByPlayerId}
              selectedTrickCardIndex={selectedTrickCardIndex}
              setSelectedTrickCardIndex={setSelectedTrickCardIndex}
              trickCardButtonRefs={trickCardButtonRefs}
              trickLayout={trickLayout}
              trickPlayCount={trickPlayCount}
              trickSurfaceRef={trickSurfaceRef}
              useScatterTrickLayout={useScatterTrickLayout}
            />
          )}
        </div>
